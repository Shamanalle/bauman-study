# Разбор кода: Лабораторная работа 2 (Вариант 10)
...
int main() {
    ...
    cout << "\n7. Операция ++ (префиксный инкремент)\n";
...
```
Префиксная форма **не** имеет фиктивного параметра `int`. Возвращает ссылку на изменённый объект.
