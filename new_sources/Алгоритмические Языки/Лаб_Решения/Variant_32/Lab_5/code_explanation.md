# Разбор кода: Лабораторная работа 5 (Вариант 32)
...
int main() {
    ...
    cout << "Дерево set (Сортировка по сумме вклада):\n";
...
```
Обход дерева `set` через range-based `for` гарантированно выдаёт элементы в **отсортированном порядке** (по сумме вклада).
