# Разбор кода: Лабораторная работа 2 (Вариант 18)
...
int main() {
    ...
    cout << "\n7. Операция -- (префиксный декремент)\n";
...
```
Префиксная форма возвращает ссылку на изменённый объект.
