# Разбор кода: Лабораторная работа 5 (Вариант 30)
...
public:
    ...
    bool operator<(const Student& other) const {
        ...
        return recordBook < other.recordBook;
    }
...
Мы избегаем этого, добавляя дополнительный критерий `recordBook` в случае равных значений основного поля (составное/каскадное условие сортировки).
