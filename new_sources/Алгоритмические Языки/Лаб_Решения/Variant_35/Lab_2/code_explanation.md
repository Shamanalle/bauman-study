# Разбор кода: Лабораторная работа 2 (Вариант 35)
...
int main() {
    ...
    cout << "\n7. Операция * (скалярное произведение): Vector * Vector\n";
    double dotProduct = v2 * v5;
    cout << "v2 * v5 = " << dotProduct << endl;
...
```
Тип возвращаемого значения — `double`, а не `Vector`. Скалярное произведение — это сумма парных произведений.
