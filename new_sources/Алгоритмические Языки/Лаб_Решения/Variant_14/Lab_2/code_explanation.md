# Разбор кода: Лабораторная работа 2 (Вариант 14)
...
int main() {
    ...
    cout << "\n7. Операция ++ (постфиксный инкремент)\n";
    cout << "v2 до инкремента: " << v2 << endl;
    Vector v6 = v2++;
...
```
Фиктивный параметр `int` отличает постфиксную форму от префиксной.
