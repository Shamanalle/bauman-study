# Разбор кода: Лабораторная работа 2 (Вариант 33)
...
int main() {
    ...
    Vector v6 = multiplier * v2;
    cout << multiplier << " * v2 = " << v6 << endl;
...
### Задание: Умножение числа на вектор (`*`)
Левый операнд — `double`, не `Vector`. Функция **обязательно** определяется вне класса.
